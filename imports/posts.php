...
/*
 * These are coming from PREPARATION.php
 *
 * $prepared_posts = [];
 * $prepared_categories = [];
 * $prepared_meta = [];
...
// var_dump( $prepared_categories );
// var_dump( $prepared_meta );
var_dump( $prepared_posts[0] );
// var_dump( $loaded_categories );

/**
 * Get the attachments for each post and update them
 */
