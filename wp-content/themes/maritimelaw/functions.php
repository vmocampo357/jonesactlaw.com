	...
	function register_attorney_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				...
				'slug'       => 'attorneys', // string (defaults to the post type name)
...
// Set up the arguments for the post type.
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'practice-areas', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_testimonial_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'testimonials', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_faq_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'faqs', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_case_result_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'case-results', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_news_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'news', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_video_cpt()
	{
		...
		$args = array(
			...
			'rewrite' => array(
				// The slug to use for individual posts of this type.
				'slug'       => 'video', // string (defaults to the post type name)
				/*// Whether to show the $wp_rewrite->front slug in the permalink.
				'with_front' => false, // bool (defaults to TRUE)
				// Whether to allow single post pagination via the <!--nextpage--> quicktag.
				'pages'      => true, // bool (defaults to TRUE)
	...
	function register_case_result_tag_tax()
	{
		...
		$args = array(
			...
			'show_admin_column' => true,
			'query_var'         => true,
			'rewrite'           => array( 'slug' => 'case-result-tag' ),
		);
	...
	*/
	...
	function claim_calculator_ajax()
	{
		...
		if (isset($_POST['email']) && $_POST['email'] != '' && isset($_POST['name']) && $_POST['name'] != '') {
			$insertRecord = sprintf("%s (%s)", $_POST['email'], $_POST['name']);
		} elseif (isset($_POST['email']) && $_POST['email'] != '') {
			$insertRecord = $_POST['email'];
		} elseif (isset($_POST['name']) && $_POST['name'] != '') {
			$insertRecord = $_POST['name'];
		}
